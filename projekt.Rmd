...
```
Tukaj bomo obravnavali kar 165 različnih valut, s katerimi se trenutno vahko trguje v posameznih državah sveta.Na spodnjem grafu so prikazane valute, ki se uporavljajo v več kot zgolj eni sami državi. Pri tem je na prvem mestu Euro, saj se uporablja v večini europskih držav, sledi pa mu Ameriški dolar.
...
valute.svet
```
Zgornji zemljevid prikazuje katere valute se uporabljajo v posameznih državah.  Za države, v katerih se uporablja večje število valut, je na zemljevidu označena zgolj ena sama. Zato dodajamo že spodnjo preglednico, ki izpostavlja omenjene dtžave.
