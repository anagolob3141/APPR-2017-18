...
if (!file.exists("podatki\\tecaji1tretjina.csv")){
...
if (!file.exists("podatki\\tecaji2tretjina.csv")){
  ...
  uredi.tabelo(tabela2.tretjina2016, "podatki\\tecaji2tretjina.csv")
}
...
if (!file.exists("podatki\\tecaji3tretjina.csv")){
  ...
  uredi.tabelo(tabela3.tretjina2016, "podatki\\tecaji3tretjina.csv")
}
